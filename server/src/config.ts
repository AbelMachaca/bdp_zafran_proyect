...
export const config = {
  ...
  emblueCrossSellEnabled: process.env.EMBLUE_CROSS_SELL_ENABLED === 'true',
  emblueCrossSellUrl: process.env.EMBLUE_CROSS_SELL_URL || '',
  emblueCrossSellToken: process.env.EMBLUE_CROSS_SELL_TOKEN || '',
  emblueCrossSellActiveFrom: validDate(process.env.EMBLUE_CROSS_SELL_ACTIVE_FROM),
